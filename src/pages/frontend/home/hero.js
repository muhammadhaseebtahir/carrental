...
export default function Hero() {
  ...
  return (
    <div className="h-auto flex flex-col items-center justify-center gap-10 md:gap-14 bg-slate-100 overflow-hidden">
      ...
      <motion.h1
        ...
        className="text-4xl pt-10 md:text-5xl font-semibold tracking-tight"
      >
        Luxury cars on Rent
      </motion.h1>
      ...
      <motion.form
        ...
        className="flex flex-col md:flex-row items-start md:items-center justify-between py-7 px-10 md:px-6 lg:px-10 rounded-lg 
                   bg-white md:rounded-full w-full max-w-80 md:max-w-3xl lg:max-w-4xl shadow-lg gap-6"
      >
