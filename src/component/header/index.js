...
export default function Header() {
  ...
  return (
    ...
    className=" sticky top-0 w-full z-50 border-b border-gray-300"
    >
      <div
        className={` flex  items-center justify-between py-4 px-6 md:px-16 lg:px-24 xl:px-32  transition-all  ${
          location.pathname === "/" ? "bg-slate-100" : "bg-white"
        } `}
      >
        <Link
          to="/"
          className="text-3xl font-bold text-black hover:scale-110 transition  duration-1000 transform hover:-rotate-2"
        >
        ...
        <div className="hidden md:flex items-center gap-4 sm:gap-8">
          ...
          <div className="hidden lg:flex items-center text-sm gap-2 rounded-full border border-gray-500 max-w-56 px-3  ">
            <input
          ...
          <div>
            {!isAuthenticated ? (
              ...
              <Space>
                <Button className="px-4 py-4 bg-slate-50">Dashboard</Button>
                <Button
                  type="primary"
                  className="px-4 py-4"
                  onClick={handleLogout}
      ...
      <div
        className={`fixed  right-0 top-0 h-full w-64 bg-white shadow-lg z-50 transition-transform duration-300 ${
      ...
      >
        ...
        <div className="p-4">
          <Input
            type="text"
            placeholder="Search....."
            className="w-full border  p-2 pl-3 text-sm mb-4 "
          />
          ...
          {!isAuthenticated ? (
            ...
            <button
              className="w-full bg-blue-500 text-white rounded-md hover-blue-700 py-2"
              onClick={handleLogout}
            >
              Logout
            </button>
            ...
            <div className="space-y-3 mt-3">
              <button className="w-full bg-blue-500 text-white rounded-md hover-blue-700 py-2">
                Dashoard
              </button>{" "}
              <button
                className="w-full bg-blue-500 text-white rounded-md hover-blue-700 py-2"
